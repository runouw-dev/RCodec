...
public class TestJSON {
    ...
    public void testJSONNull(){
        ...
        // re-encode
        node = new CoderNode().fromString(node.toString());
    ...
    @Test
    public void testJSONTypesInArray(){
        ...
        arr = new CoderArray().fromString(arr.toString());
    ...
    @Test
    public void testJSONTypesInNode(){
        CoderNode node = new CoderNode();
    ...
    public void testJSONNested(){
        ...
        CoderNode decoded = new CoderNode().fromString(root.toString());
        decoded
